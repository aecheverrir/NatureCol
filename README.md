<img src="https://enciclopediadecolombia.wikispaces.com/file/view/guacamayas.jpg/248134669/800x533/guacamayas.jpg" title="NatureCol" alt="NatureCol logo" href="">

# NatureCol
> WebApp that allows you to see flora and founa from Colombia.
...
- use `cd NatureCol` to enter the main folder
...
- Clone this repo to your local machine using git typing this in your cosole: `git clone https://github.com/aecheverrir/NatureCol.git`
